...
rew_types=( "simp" "base" "dirs" "delta" ) # "pos_simp" "delta" "dirs" ) #"base" ) "wrench_norm"
exp_tag="Agent_Voltron" #"long_baseline" #"exps_AUG15" #"hybrid_baseline_llr"
...
do
	...
	if [[ "$hybrid_agent" -eq 1 ]]; then
	    name="hybrid_agent_$name"
	elif [[ "$hybrid_control" -eq 1 ]]; then
	    name="hybrid_$name"
	...
	do
	    ...
	    sbatch -J "${nick_names[$task_idx]}_${name}_${rew_type}_${break_force}" exp_control/HPC_utils/hpc_batch_hybrid.bash \
		   $task_idx \
		   $obs_idx \
		   $name \
		   $exp_tag \
