...
#SBATCH -p tiamat,gpu,tiamat,dgx2		# name of partition or queue
##SBATCH -p tiamat,gpu
##SBATCH -p tiamat
...
#SBATCH -c 12                   # number of cores/threads per task (default 1)
#SBATCH -o ../voltron/%A.out		# name of output file for this submission script
#SBATCH -e ../voltron/%A.err		# name of error file for this submission script
