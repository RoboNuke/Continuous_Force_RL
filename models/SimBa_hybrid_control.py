...
from models.SimBa import SimBaNet, ScaleLayer
    ...
    def __init__(
        ...
        if self.init_scale_weights:
            ...
            with torch.no_grad():
                ...
                self.actor_mean.output[-1].weight[:self.force_size,:] *= scale_factor
                self.actor_mean.output[-1].bias[:self.force_size] *= scale_factor
        ...
        if self.scale_z:
            ...
            self.actor_mean.output.insert(-1, ScaleLayer(scale_factor=scale_factor))
