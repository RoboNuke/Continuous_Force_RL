...
def main():
    ...
    if wrappers_config.get('efficient_reset', {}).get('enabled', False):
        print("  - Applying EfficientResetWrapper")
        env = lUtils.apply_efficient_reset_wrapper(env, wrappers_config['efficient_reset'])
